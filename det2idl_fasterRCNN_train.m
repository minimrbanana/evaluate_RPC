function det2idl_fasterRCNN_train(Min_score, Nms_box, N_box)
...
% dir setting
dataDir = '/BS/joint-multicut-2/work/FBMS-fasterRCNN/Trainingset02/';
Type = '*.mat';

idlDir = '/BS/joint-multicut-2/work/FBMS-fasterRCNN/RPC-plot/Training/';
...
%fid = fopen(idlName,'w');
fid = fopen(['fasterRCNN_' boxDirout '_train.idl'],'w');
