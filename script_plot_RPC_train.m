...
rpcFile = save_RPC_txt_train(txt_file);

% plot the RP curve
textFile = ['/BS/joint-multicut-2/work/FBMS-fasterRCNN/RPC-plot/Training/evaluate/' txt_file '_rpc.txt'];
fid = fopen(textFile);
...
axis([0 1 0 1]);
title(txt_file);
figureFile = ['/BS/joint-multicut-2/work/FBMS-fasterRCNN/RPC-plot/Training/' txt_file '_rpc.jpg'];
saveas(h,figureFile);
clf;
end
end